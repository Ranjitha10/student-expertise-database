...
<title>Student-Counsellor Details</title>
...
?>
<h1 align="center" color="FF0000">Counsels </h1>
<br><br><br>
...
<form method="post" action="COUNSELS2.php">
<div id="bodyfull">
<br><br><br><br><br><br><br><br><br><br>
<div id="bodyfull2">
<h1 align="center" color="#DF013A"  >Student-Counsellor Details</h1>
	<div id="center">
		...
		<form name="register" action="#null" method="post" id="register">
			<div class="form_box">
				...
				<div>
							...
							<SELECT name="Fid"> <OPTION VALUE=0>Choose
								<?php 
								$servername = "localhost";
								$username = "root";
								$password = "";
								$dbname = "student_expertize";
									// Create conection
								 $con = new mysqli($servername, $username, $password, $dbname);
								 $result = mysqli_query($con,"SELECT Fid FROM counsellor");
								 while($row = mysqli_fetch_array($result))
								 {
								  $Fid=$row["Fid"];
				...
				<div>
				<form name="myForm" action="COUNSELS2.php" onsubmit="return validateForm()" method="post">
					<label>&nbsp; &nbsp;</label>
