...
<meta name="title" content="Achievement Details"/>
...
<form method="post" action="ACHAN2.php">
<div id="bodyfull">
<br><br><br><br><br><br><br><br><br><br>
<div id="bodyfull2">
<h1 align="center" color="FF0000">Achievement Details</h1>
<br><br><br><br><br><br><br><br>
<h3 align="center" color="FF0000">enter the Achievement Name whose achievements has to be retrieved</h3>
	<div id="center">
		...
		<form name="register" action="#null" method="post" id="register">
				...
				<div>
					<label>Achievement Name</label>
							<SELECT name="AchievementName"> <OPTION VALUE=0>Choose
								<?php 
								...
								$dbname = "student_expertize";
								 ...
								 $result = mysqli_query($con,"SELECT AchievementName FROM achievements");
								 while($row = mysqli_fetch_array($result))
								 {
								  $AchievementName=$row["AchievementName"];
								  echo '<OPTION VALUE=\'' . $AchievementName . '\'>'.$AchievementName.'</OPTION>';
								  }
				...
				<div>
				<form name="myForm" action="ACHAN2.php" onsubmit="return validateForm()" method="post">
					<label>&nbsp; &nbsp;</label>
