...
<body style="background-image: url(Delete.jpg); use oncontextmenu="return false;">
<form method="post" action="del2.php">
<div id="bodyfull">
<br><br><br><br><br><br><br><br><br><br>
<div id="bodyfull2">
<h1 align="center" color="#DF013A"  >Deleting Student Record</h1><br><br>
	<div id="center">
		...
		<form name="register" action="#null" method="post" id="register">
			<div class="form_box">
				...
				<h3 align="center"  >Enter the USN whose record should be deleted</h3><br><br><br><br><br>
				<div>
				...
				<div>
				<form name="myForm" action="del2.php" onsubmit="return validateForm()" method="post">
					<label>&nbsp; &nbsp;</label>
