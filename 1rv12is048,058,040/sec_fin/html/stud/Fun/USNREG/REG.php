...
<title>USN GENERATION</title>
<meta name="title" content="USN GENERATION"/>
...
<div id="bodyfull2">
<h1 align="center" color="FF0000">USN GENERATION</h1>
<br><br><br><br><br><br><br><br>
<h3 align="center" color="FF0000">enter the name of the student</h3>
	<div id="center">
		...
		<form name="register" action="#null" method="post" id="register">
				...
				<div>
				<form name="myForm" action="REG2.php" onsubmit="return validateForm()" method="post">
					<label>&nbsp; &nbsp;</label>
