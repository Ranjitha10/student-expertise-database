...
<title>CLUB DETALS</title>
<meta name="title" content="CLUB DETALS"/>
...
<body style="background-image:url(nnn.jpg)";use oncontextmenu="return false;">
<form method="post" action="login.php">
<div id="bodyfull">
<br><br><br><br><br><br><br><br><br><br>
<div id="bodyfull2">
<h1 align="center" color="fe2e64">Co-Curricular Activities </h1>
	<div id="center">

		<div class="inner_right_demo"> 
		<form name="register" action="login.php" method="post" id="register">
		
		
			<div class="form_box" >
					      <div>
							<label>Club Name</label>
							<input type="text" placeholder="  eg: Carv  " id="clubname" name="clubname"  required/><br><br><br>
						     </div>
				
				<div>
					<label>Role</label>
					<input type="text" placeholder="  eg: president  " id="role" name="role"  required/><br><br><br>
				</div>
				
				<div>
					<label>Category</label>
					<input type="text" placeholder="  eg: dance  " id="category" name="category"  required/><br><br><br>
				</div>	
				
				<div>
					<label>Date of Join</label>
					<input type="date"  id="joindate" name="joindate"  required/><br><br><br>
				</div>
