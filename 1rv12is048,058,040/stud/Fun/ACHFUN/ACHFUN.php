...
<form method="post" action="ACHFUN2.php">
<div id="bodyfull">
<br><br><br><br><br><br><br><br><br><br>
<div id="bodyfull2">
<h1 align="center" color="FF0000">Achievement Details</h1>
<br><br><br><br><br><br><br><br>
<h3 align="center" color="FF0000">enter the Full Name whose achievements has to be retrieved</h3>
	<div id="center">
		...
		<form name="register" action="#null" method="post" id="register">
				...
				<div>
					<label>Full Name</label>
							<SELECT name="Fname"> <OPTION VALUE=0>Choose
								<?php 
								...
								$dbname = "student_expertize";
								 ...
								 $result = mysqli_query($con,"SELECT Fname FROM student");
				...
				<div>
				<form name="myForm" action="ACHFUN2.php" onsubmit="return validateForm()" method="post">
					<label>&nbsp; &nbsp;</label>
