...
<form method="post" action="ACHAT2.php">
<div id="bodyfull">
<br><br><br><br><br><br><br><br><br><br>
<div id="bodyfull2">
<h1 align="center" color="FF0000">Achievement Details</h1>
<br><br><br><br><br><br><br><br>
<h3 align="center" color="FF0000">enter the Achievement Type whose achievements has to be retrieved</h3>
	<div id="center">
		...
		<form name="register" action="#null" method="post" id="register">
				...
				<div>
				<form name="myForm" action="ACHAT2.php" onsubmit="return validateForm()" method="post">
					<label>&nbsp; &nbsp;</label>
